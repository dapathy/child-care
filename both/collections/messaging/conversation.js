...
import { Message, MessagesCollection } from './message';
import {ParticipantsCollection, Participant} from './participant';

const ConversationsCollection = new Meteor.Collection('conversations');
...
class Conversation {
    ...
    sendMessage(body, callback) {
        let message = { body, conversationId: this._id, inFlight: true };
        MessagesCollection.insert(message, callback);
    }
    ...
    addParticipant(participant) {
        let newParticipant = { userId: participant._id, conversationId: this._id };
        ParticipantsCollection.insert(newParticipant);
    }
